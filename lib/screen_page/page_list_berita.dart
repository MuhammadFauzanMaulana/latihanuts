...
import 'package:latihanuts/screen_page/detail_berita.dart';
...
class _ListBeritaState extends State<ListBerita> {
  ...
  Future<List<Datum>?> getBerita() async{
    try{
      ...
      http.get(Uri.parse("http://192.168.124.51/edukasi_server/getBerita.php"));
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.124.51/edukasi_server/gambar_berita/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
